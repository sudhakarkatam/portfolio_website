           ...
           {navItems.map((item) => (
             <div key={item.id} className={item.desktopOnly ? 'hidden md:block' : ''}>
               <Button
                 ...
                 } hover:bg-sidebar-accent transition-all duration-300 ${isMobile ? 'text-sm min-h-[44px] touch-manipulation' : 'text-base'}`}
                onClick={() => {
                  if (item.hasSubmenu) {
                    toggleProjects();
                  } else {
                  ...
                  >
                       ...
                       return (
                         <Button
                           ...
                           variant="ghost"
                           size="sm"
                           className={`w-full justify-start ${isMobile ? 'text-xs min-h-[40px] touch-manipulation' : 'text-sm'} hover:bg-sidebar-accent hover:text-accent transition-all`}
                           onClick={() => {
