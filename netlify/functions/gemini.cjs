// Netlify function for secure Gemini AI integration
// This function proxies requests to Google Gemini API with server-side API key protection
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const timeoutId = setTimeout(() => controller.abort(), 25000); // 25 second timeout for Netlify
