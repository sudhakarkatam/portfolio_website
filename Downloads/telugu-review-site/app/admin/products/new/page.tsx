            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="rating" name="rating" type="number" min="1" max="5" step="0.1" required />
                </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="affiliateUrl" name="affiliateUrl" type="url" required />
              </div>

              <div className="space-y-2">
                <Label htmlFor="videoId">YouTube Video ID (optional)</Label>
                <Input id="videoId" name="videoId" placeholder="e.g., dQw4w9WgXcQ" />
              </div>
